...
// CLP Compass's own sub-navigation — moved out of the global CDB header so
  ...
  return (
    <div>
      <nav style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 24, flexWrap: 'wrap' }}>
        <Link href="/patients" style={navLinkStyle}>Patients</Link>
        <Link href="/coaches" style={navLinkStyle}>Coaches</Link>
        <Link href="/guide-images" style={navLinkStyle}>Picture bank</Link>
        <Link href="/recipe-bank" style={navLinkStyle}>Recipe bank</Link>
      </nav>
      {children}
    </div>
  )
