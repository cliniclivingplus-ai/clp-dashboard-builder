...
// /api/interpret and /api/qa-chat, kept self-contained here rather than
  ...
  try {
    ...
    const completion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `You are a functional-medicine nutritionist at Clinic Living Plus, designing a SINGLE-CONSULTATION goal checklist page for "${patient.full_name}" — not a multi-month roadmap, just what matters for the next consultation.
